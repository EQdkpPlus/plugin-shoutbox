...
function showShoutboxRequest(root, text) {
  ...
  $('#shoutbox_button').html('<i class="icon-refresh icon-spin icon-large"></i>'+text);
}
...
function reloadShoutboxRequest(root) {
  ...
  $('#shoutbox_reload_button').html('<i class="icon-refresh icon-spin icon-large"></i>');
}
...
function deleteShoutboxRequest(root, id, textDelete) {
  $('#shoutbox_delete_button_'+id).html('<i class="icon-refresh icon-spin icon-large"></i>');
}
